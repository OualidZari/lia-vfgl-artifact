...
function run_experiment() {
    ...
    (cd .. && python main.py --dataset ${dataset} --device cuda --gpu 2 --seed ${seed} --lr 0.01 --epochs 300 --val_ratio 0.02 \
        --train_ratio 0.5 \
        ...
        --local_logging \
        --experiment_name "Defense Label Randomization results ${dataset}" \
        --attack_epochs [-1] \
        --label_defense \
